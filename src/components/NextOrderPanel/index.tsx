...
export default function NextOrderPanel({
    ...
    return (
        <div className={"mx-1 mt-1 mb-3 w-full"}>
            <NextOrderDisplay orderID={orderID} timeLeft={1702399249793 + 3600000}/>
            <NextOrderResult orderID={orderID} timeLeft={1702399249793 + 3600000} result={62570}/>
            <NextOrderBanner orderID={orderID} timeLeft={1702399249793 + 3600000} result={62570}/>
        </div>
    )
}
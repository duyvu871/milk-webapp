...
export default function SpinningWheel() {
    ...
    return (
        <div className={"w-full h-full flex flex-col justify-center items-center mb-4 "}>
            {/*<Marker />*/}
            <div className={"w-1/2 h-1/2 flex justify-center items-center relative z-2"}>
                <Image src={"/images/11zon_cropped.png"} alt={"Rotation wheel"} width={120} height={120} className={"wheel"} ref={wheel}/>
            </div>
